...
public class Restrict {
	...
	public static final String DATA_AUTHORITY_TYPE_OWNER = "OWNER";

	public static final String DATA_AUTHORITY_TYPE_READER = "READER";

	public static final String DATA_AUTHORITY_TYPE_WRITER = "WRITER";
}
