...
public class MsSqlQuestionnaireDAO  extends AbstractQuestionnaireDAO implements QuestionnaireDAO {
	
	public MsSqlQuestionnaireDAO(Connection conn) throws Exception {
		super(conn);
		dbTag = "MS SQL SERVER: ";
		try {
