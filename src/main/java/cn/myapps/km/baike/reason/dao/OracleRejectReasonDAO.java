 ...
 * 
 */
public class OracleRejectReasonDAO extends AbstractRejectReasonDAO implements RejectReasonDao {

	public OracleRejectReasonDAO(Connection conn) throws Exception {
		super(conn);
		if (conn != null) {
			try {
