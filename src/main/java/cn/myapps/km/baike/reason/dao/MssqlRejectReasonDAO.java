 ...
 * 
 */
public class MssqlRejectReasonDAO extends AbstractRejectReasonDAO implements RejectReasonDao {

	public MssqlRejectReasonDAO(Connection conn) throws Exception {
		super(conn);
		dbTag = "MS SQL SERVER: ";
		try {
