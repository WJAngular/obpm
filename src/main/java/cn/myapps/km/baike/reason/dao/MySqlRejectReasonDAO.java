 ...
 * 
 */
public class MySqlRejectReasonDAO extends AbstractRejectReasonDAO implements RejectReasonDao {

	public MySqlRejectReasonDAO(Connection conn) throws Exception {
		super(conn);
		dbTag = "MY SQL: ";
		try {
