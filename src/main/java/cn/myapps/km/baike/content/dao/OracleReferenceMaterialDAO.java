...
public class OracleReferenceMaterialDAO extends AbstractReferenceMaterialDAO implements ReferenceMaterialDAO{
	
	
	public OracleReferenceMaterialDAO(Connection conn) throws Exception {
		super(conn);
		if (conn != null) {
			try {
