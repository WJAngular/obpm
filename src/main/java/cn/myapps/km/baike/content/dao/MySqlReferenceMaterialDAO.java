...
public class MySqlReferenceMaterialDAO extends AbstractReferenceMaterialDAO implements ReferenceMaterialDAO{
	
	
	public MySqlReferenceMaterialDAO(Connection conn) throws Exception {
		super(conn);
