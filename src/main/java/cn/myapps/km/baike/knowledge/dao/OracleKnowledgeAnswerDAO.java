...
public class OracleKnowledgeAnswerDAO extends AbstractKnowledgeAnswerDAO implements KnowledgeAnswerDAO{
	
	
	public OracleKnowledgeAnswerDAO(Connection conn) throws Exception {
		super(conn);
		if (conn != null) {
			try {
