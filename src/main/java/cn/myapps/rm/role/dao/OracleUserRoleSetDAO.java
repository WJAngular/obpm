...
public class OracleUserRoleSetDAO extends AbstractUserRoleSetDAO implements UserRoleSetDAO {

	public OracleUserRoleSetDAO(Connection conn) throws Exception {
		super(conn);
		if (conn != null) {
			try {
