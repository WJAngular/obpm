...
public class OracleResourceUsageDAO extends AbstractResourceUsageDAO implements ResourceUsageDAO {

	public OracleResourceUsageDAO(Connection conn) throws Exception {
		super(conn);
		if (conn != null) {
			try {
