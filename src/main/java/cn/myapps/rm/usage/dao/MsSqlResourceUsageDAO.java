...
public class MsSqlResourceUsageDAO extends AbstractResourceUsageDAO implements ResourceUsageDAO{
	
	public MsSqlResourceUsageDAO(Connection conn) throws Exception {
		super(conn);
		dbTag = "MS SQL SERVER: ";
		try {
