...
public class DB2ResourceUsageDAO extends AbstractResourceUsageDAO implements ResourceUsageDAO {

	public DB2ResourceUsageDAO(Connection conn) throws Exception {
		super(conn);
		if (conn != null) {
			try {
