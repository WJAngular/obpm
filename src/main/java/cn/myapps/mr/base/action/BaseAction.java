package cn.myapps.mr.base.action;
...
public abstract class BaseAction<E> extends ActionSupport{
	...
	protected static final String ACTION_COUNT_KEY = "count";
	...
	public WebUser getUser(){
		...
		if (session == null || session.get(Web.SESSION_ATTRIBUTE_FRONT_USER) == null)
			...
			user = getAnonymousUser();//(WebUser) session.get(Web.SESSION_ATTRIBUTE_FRONT_USER);
    ...
    public void addActionCount(Integer count){
    	dataMap.put(ACTION_COUNT_KEY,count);
    }
