...
public class DomainServiceSoapBindingStub extends org.apache.axis.client.Stub
		implements cn.myapps.webservice.client.DomainService {
	...
	private static void _initOperationDesc1() {
		...
		oper.addParameter(param);
		oper.setReturnType(new javax.xml.namespace.QName(
				"urn:model.webservice.myapps.cn", "SimpleDomain"));
	...
	public java.lang.Object[] searchDomainsByDomainAdmin(
		...
		try {
			java.lang.Object _resp = _call
					.invoke(new java.lang.Object[] { domainAdminId });
	...
	public cn.myapps.webservice.model.SimpleDomain searchDomainByName(
		...
		_call
				.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
		_call.setOperationName(new javax.xml.namespace.QName(
				"http://client.webservice.myapps.cn", "searchDomainByName"));

		setRequestHeaders(_call);
		setAttachments(_call);
		try {
			java.lang.Object _resp = _call
					.invoke(new java.lang.Object[] { name });
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (cn.myapps.webservice.model.SimpleDomain) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									cn.myapps.webservice.model.SimpleDomain.class);
				}
			}
		} catch (org.apache.axis.AxisFault axisFaultException) {
			if (axisFaultException.detail != null) {
