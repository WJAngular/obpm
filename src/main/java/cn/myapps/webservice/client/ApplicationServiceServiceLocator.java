...
public class ApplicationServiceServiceLocator extends org.apache.axis.client.Service implements
		cn.myapps.webservice.client.ApplicationServiceService {
	...
	public ApplicationServiceServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
			throws javax.xml.rpc.ServiceException {
		super(wsdlLoc, sName);
	}

	// Use to get a proxy class for ApplicationService
	private java.lang.String ApplicationService_address = "http://localhost:8080/obpm/services/ApplicationService";
	...
	public cn.myapps.webservice.client.ApplicationService getApplicationService(String loginno, String password,
	...
	public cn.myapps.webservice.client.ApplicationService getApplicationService(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			cn.myapps.webservice.client.ApplicationServiceSoapBindingStub _stub = new cn.myapps.webservice.client.ApplicationServiceSoapBindingStub(
					portAddress, this);
