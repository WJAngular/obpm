...
public class FilterExpression {
	...
	public final static String DOCUMENT_CLASSNAME = "cn.myapps.core.dynaform.document.ejb.Document";

	public final static String ITEM_CLASSNAME = "cn.myapps.core.dynaform.document.ejb.Item";
   /**
