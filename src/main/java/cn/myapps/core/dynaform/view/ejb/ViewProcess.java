...
public interface ViewProcess extends IDesignTimeProcess<View> {
	...
	public Collection<View> getViewsByModule(String moduleid, String application)
			throws Exception;
	 ...
	 * @return 返回文件名
	 */
	public String expDocToExcel(String viewid, WebUser user, ParamsTable params)
			throws Exception;
	 ...
	 */
	public String getQueryString(View view, ParamsTable params, WebUser user,
			Document sDoc);
	 ...
	 * @throws Exception
	 */
	public abstract void doRemove(Collection<View> viewList) throws Exception;

	public DataPackage<Document> getDataPackage(View view, ParamsTable params,
