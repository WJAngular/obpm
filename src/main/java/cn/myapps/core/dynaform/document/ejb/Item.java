...
public class Item implements Serializable {
	 ...
	 * 
	 * @see cn.myapps.core.dynaform.document.ejb.Item#VALUE_TYPE_INCLUDE
	 * @see cn.myapps.core.dynaform.document.ejb.Item#VALUE_TYPE_NUMBER
	 * @see cn.myapps.core.dynaform.document.ejb.Item#VALUE_TYPE_VARCHAR
	 * @see cn.myapps.core.dynaform.document.ejb.Item#VALUE_TYPE_TEXT
	 * @see cn.myapps.core.dynaform.document.ejb.Item#VALUE_TYPE_DATE
	 * @return item
	 * @uml.property name="type"
	 */
	...
	public void setValue(Object value) {// 
		if (value == null) {
			...
			if(value instanceof Double){
				...
				this.setVarcharvalue(format.format(value));
			}else {
			...
			if(value instanceof Double){
				DecimalFormat format = new DecimalFormat("#.######");
				this.setTextvalue(format.format(value));
			}else {
