...
public abstract class IncludedElement implements Serializable {
	 ...
	 * @throws Exception
	 */
	public abstract String toXMLTxt2(Document doc, IRunner runner, WebUser webUser) throws Exception;
	...
	public abstract String toPdfHtmlTxt(Document doc, IRunner runner, WebUser webUser) throws Exception;
