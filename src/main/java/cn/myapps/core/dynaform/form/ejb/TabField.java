...
public class TabField extends FormField {
	...
	public String toTemplate() {
		...
		template.append("src=\"/obpm/core/dynaform/form/formeditor/buttonimage/v1/tag.gif\"");
		template.append("className=\"cn.myapps.core.dynaform.form.ejb.TabField\"");
	...
	public String toHtmlTxt(Document doc, IRunner runner, WebUser webUser, int permissionType) throws Exception {
		...
		return tabMode.toHtmlTxt(doc, runner, webUser,displayType);
	}
	...
	public String toPdfHtmlTxt(Document doc, IRunner runner, WebUser webUser)
			throws Exception {
		return tabMode.toPdfHtmlTxt(doc, runner, webUser);
	}
	...
	public String getRefreshScript(IRunner runner, Document doc, WebUser webUser) throws Exception {
		...
		return tabMode.getRefreshScript(runner, doc, webUser,displayType);
	}
	...
	public String toMbXMLText2(Document doc, IRunner runner, WebUser webUser)
			throws Exception {
		return tabMode.toMbXMLText2(doc, runner, webUser);
	}
}
