...
public class ExcelMappingDiagram extends Canvas {
	...
	public static final String IMPORT_ROLLBACK_ALL = "rollback";
	
	public static final String IMPORT_NOT_ROLLBACK_ALL = "notRollback";
	...
	public String toXML() throws IllegalAccessException, ClassNotFoundException {
		...
		try {
			...
			for (java.util.Enumeration<Element> em = this._elems.elements(); em
					.hasMoreElements();) {
