...
public class ColumnMapping extends ValueObject {
	 ...
	 * @hibernate.many-to-one  class="cn.myapps.core.dynaform.form.ejb.Form"  column="FORMID"
	...
	/**
	 * @hibernate.many-to-one  column="MAPPINGCONFIG"  class="cn.myapps.core.dynaform.dts.exp.mappingconfig.ejb.MappingConfig"
