...
public class MappingConfig extends ValueObject {
	 ...
	 * @hibernate.many-to-one  class="cn.myapps.core.deploy.module.ejb.ModuleVO"  column="MODULE"
	 ...
	 * @hibernate.collection-one-to-many  class="cn.myapps.core.dynaform.dts.exp.columnmapping.ejb.ColumnMapping"
	 * @return
	...
	/**
	 * @hibernate.many-to-one  column="DATASOURCE"  class="cn.myapps.core.dynaform.dts.datasource.ejb.DataSource"
	 ...
	 * @hibernate.collection-many-to-many  class="cn.myapps.core.report.reportconfig.ejb.ReportConfig"  column="REPORT_ID"
