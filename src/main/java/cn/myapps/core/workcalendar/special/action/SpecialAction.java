package cn.myapps.core.workcalendar.special.action;
...
import cn.myapps.core.workcalendar.special.ejb.SpecialDayProcess;
...
public class SpecialAction extends BaseAction<SpecialDayVO> {
	...
	public void setDate() throws Exception {
		...
		try {
			...
			throw new OBPMValidateException("{*[core.workcalendar.special.enddate.patternerror]*}");
		}
		try {
			...
			throw new OBPMValidateException("{*[core.workcalendar.special.startdate.patternerror]*}");
		}
	}
