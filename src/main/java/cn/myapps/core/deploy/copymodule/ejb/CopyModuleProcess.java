...
public interface CopyModuleProcess extends IDesignTimeProcess<CopyModuleVO> {
	 ...
	 * @throws Exception
	 */
	public Form copyForm(CopyModuleVO vo, String moduleId, String formId, String _formid) throws Exception;
	 ...
	 * @throws Exception
	 */
	public BillDefiVO copyFlow(CopyModuleVO vo, String moduleId, BillDefiVO newBillDefiVO, String newFlowid) throws Exception;
