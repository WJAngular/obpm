...
public class ColumnChart {
    ...
    public static JFreeChart createChart(
    	...
    	standardChartTheme.setExtraLargeFont(new Font("宋体",Font.BOLD, 23));    //设置标题字体          
    	standardChartTheme.setRegularFont(new Font("宋体",Font.BOLD, 12));    //设置图例的字体       
    	standardChartTheme.setLargeFont(new Font("宋体",Font.BOLD, 12));      //设置轴向的字体      
