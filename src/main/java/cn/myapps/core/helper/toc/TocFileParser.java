...
import cn.myapps.core.helper.toc.impl.DocumentReader;
import cn.myapps.core.helper.toc.impl.Toc;
import cn.myapps.core.multilanguage.action.MultiLanguageUtil;
...
public class TocFileParser extends DefaultHandler {
	...
	public Toc getToc(String language) throws IOException, SAXException, ParserConfigurationException {
		...
		return (Toc) language2tocMap.get(language);
	}
