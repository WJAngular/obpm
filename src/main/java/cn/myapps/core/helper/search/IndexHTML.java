...
public class IndexHTML {
	...
	private static final Logger Log = Logger.getLogger(IndexHTML.class);
	...
	private void indexDocs(File file) throws Exception {
		if (file.isDirectory()) { // if a directory
			...
			if (uidIter != null) {
				...
				while (uidIter.term() != null && uidIter.term().field() == "id" && uidIter.term().text().compareTo(id) < 0) {
				...
				if (uidIter.term() != null && uidIter.term().field() == "id" && uidIter.term().text().compareTo(id) == 0) {
