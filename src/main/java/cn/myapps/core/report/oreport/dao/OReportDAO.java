package cn.myapps.core.report.oreport.dao;
...
public interface OReportDAO extends ReportDAO{
	 ...
	 * @param goby
	 */
	public List<Map<String, String>> getFilterItemsData(String tabName, JSONObject filter, String goby) throws Exception;
	 ...
	 * @return
	 */
	public String getWhereFilterSql(JSONArray whereFilters);
	 ...
	 * @return
	 */
	public String getHavingFilterSql(JSONArray havingFilters);
