...
import cn.myapps.core.report.standardreport.action.ReportUtil;
...
public abstract class AbstractStandardReportDAO extends AbstractReportDAO  {
	...
	public abstract String getSql(String formId, String startdate, String enddate,
	...
	public String getCountSql(String formId, String startdate, String enddate,
		...
		return getSql(formId, startdate, enddate, columnName, application, dbmethod);
	}
