...
public abstract class AbstractRunner implements IRunner {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.myapps.core.macro.runner.IRunner#run(java.lang.String,
	 * java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.myapps.core.macro.runner.IRunner#readBaseLib()
	 */
	/**
	 ...
	 * 
	 * @see
	 * cn.myapps.core.macro.runner.IRunner#initBSFManager(cn.myapps.core.dynaform
	 * .document.ejb.Document, cn.myapps.base.action.ParamsTable,
	 * cn.myapps.core.user.action.WebUser, java.util.Collection)
	 */
	/**
	...
	public void initBSFManager(Document currdoc, ParamsTable params, WebUser user, Collection<ValidateMessage> errors)
		...
		if (params != null && !StringUtil.isBlank(this.getApplicationId()) && StringUtil.isBlank(params.getParameterAsString("application"))) {
