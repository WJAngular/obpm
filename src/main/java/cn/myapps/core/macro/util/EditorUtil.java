...
public class EditorUtil {
	...
	static{
		...
		clazzes.add("cn.myapps.core.dynaform.document.ejb.Document");
		clazzes.add("cn.myapps.core.dynaform.document.ejb.DocumentProcessBean");
		clazzes.add("cn.myapps.core.dynaform.document.ejb.Item");
	}
