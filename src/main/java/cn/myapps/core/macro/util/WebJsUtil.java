...
public class WebJsUtil {
	...
	public String getParameterAsString(String tag) {
		String value = (String) _params.getParameterAsString(tag);
		return (value == null) ? "" : value;
	}
	...
	public String getApplication() {
		...
		if(StringUtil.isBlank(appid) && _doc != null){
			appid = _doc.getApplicationid();
		}
		return appid;
	}
	...
	public String getDomainid() {
		...
		if(StringUtil.isBlank(domainid) && _doc != null){
			domainid = _doc.getDomainid();
		}
		return domainid;
	}
