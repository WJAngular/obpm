...
public interface CounterProcess extends IRunTimeProcess<CounterVO> {
	 ...
	 * @throws Exception
	 */
	public abstract void doRemoveByName(String name, String application, String domainid) throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract int getNextValue(String name, String application, String domainid) throws Exception;
