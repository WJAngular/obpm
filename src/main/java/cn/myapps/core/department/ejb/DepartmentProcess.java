...
public interface DepartmentProcess extends IDesignTimeProcess<DepartmentVO> {
	 ...
	 * 
	 * @param ParamsTable
	 * @see cn.myapps.base.ejb.IDesignTimeProcess#doSimpleQuery(cn.myapps.base.action.ParamsTable)
	 * @return 部门集合
	 */
	public abstract Collection<DepartmentVO> doSimpleQuery(ParamsTable params) throws Exception;
	 ...
	 * @throws Exception
	 */
	public Map<String, String> deepSearchDepartmentTree(Collection<DepartmentVO> cols, DepartmentVO startNode, String excludeNodeId, int deep)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	public Collection<DepartmentVO> getUnderDeptList(String depid) throws Exception;
	 ...
	 * @throws Exception
	 */
	public Collection<DepartmentVO> getUnderDeptList(String id, int maxDeep, boolean isExcludeSelf) throws Exception;
	 ...
	 * @throws Exception
	 */
	public Collection<DepartmentVO> doQueryLineSubordinatesByIndexCode(String indexCode) throws Exception;
	 ...
	 * @throws Exception
	 */
	public Collection<DepartmentVO> doQueryAllSuperiorsByIndexCode(String indexCode) throws Exception;
	 ...
	 * @throws Exception
	 */
	public Collection<DepartmentVO> doQueryAllSubordinatesByIndexCode(String indexCode) throws Exception;
