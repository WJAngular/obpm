 ...
 *
 */
public class ManualNodeTimingApprovalJob implements Job {
	...
	public ManualNodeTimingApprovalJob(String docId, String flowStateId,
	...
	public void execute() throws Exception {
		try {
			...
			if(nodert !=null){
				...
				if (currNode != null && nextNodeList != null && !nextNodeList.isEmpty()) {
					...
					params.setParameter("TIMELIMIT", true);
					
					instanceProcess.doApprove(params, instance, nodert.getNodeid(),
							nextids, FlowType.RUNNING2RUNNING_TIMELIMIT, "",user);
