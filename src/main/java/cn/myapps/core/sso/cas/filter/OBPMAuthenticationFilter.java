package cn.myapps.core.sso.cas.filter;
...
import cn.myapps.core.sso.CasUserSSO;
...
public class OBPMAuthenticationFilter extends AbstractCasFilter {
	...
	protected void initInternal(final FilterConfig filterConfig) throws ServletException {
		if (!isIgnoreInitConfiguration()) {
			...
			String redirectUrl = PropertyUtil.get(Web.SSO_REDIRECT);
			...
			setService(redirectUrl);
			log.trace("Loading service property: " + redirectUrl);
	...
	public final void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
		...
		if (assertion != null || !isCasSSO() || isFromWeixin(request)) {
