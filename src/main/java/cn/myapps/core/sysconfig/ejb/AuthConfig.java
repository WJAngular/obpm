...
public class AuthConfig implements java.io.Serializable {
	...
	static {
		LOGINAUTH.put("default",
				"cn.myapps.core.sso.autherticator.DefaultLoginAuthenticator");// 默认的登录验证
		/*LOGINAUTH.put("ldap",
				"cn.myapps.core.sso.autherticator.LDAPLoginAuthenticator");*/// LDAP登录验证
		LOGINAUTH.put("ldap",
		"cn.myapps.core.sso.autherticator.ADLoginAuthenticator");
	}
	/**
	 * 单点登录方式
	 */
	...
	static {
		SSOAUTH.put("cookie", "cn.myapps.core.sso.CookieCasUserSSO");
		SSOAUTH.put("cas", "cn.myapps.core.sso.CasUserSSO");// cas服务器单点登录方式
	}
	/**
	 * 默认邮箱地址key
	 */
	 ...
	 * 是否启用USBKey身份验证
	 */
	public static final String UK_AUTHENTICATE = "usbkey.authenticate";
	
	/**
	 * USBKey身份验证作用模式
	 */
	public static final String UK_AFFECTMODE = "usbkey.affect.mode";
	/**
	 * USBKey身份验证作用IP范围
	 */
	public static final String UK_RANGEIPS = "usbkey.rangeips";
	
	/**
	 * AD服务器管理员账号
	 */
	public static final String AD_ADMIN_LOGINNO = "ad.admin.loginno";
	
	/**
	 * AD服务器管理员账号密码
	 */
	public static final String AD_ADMIN_LOGINNOPW = "ad.admin.loginnopw";
	
	/**
	 * AD登陆时企业域
	 */
	public static final String AD_LOGIN_DOMAIN = "ad.login.domain";
	...
	private String adadminloginno;
	private String adadminloginnopw;
	private String adlogindomain;
	/**
	 * 是否开启手机短信验证
	 */
	 ...
	 * 是否开启USBKey身份认证
	 */
	private String usbkeyAuthenticate;
	
	/**
	 * USBKey身份认证作用模式（all验证所有|match验证特定范围|exclude排除特定范围）
	 */
	private String usbkeyAffectMode;
	
	/**
	 * usbkey身份认证作用ip范围（json格式）
	 */
	private String usbkeyRangeIps;
	
	public String getUsbkeyAuthenticate() {
		return usbkeyAuthenticate;
	}

	public void setUsbkeyAuthenticate(String usbkeyAuthenticate) {
		this.usbkeyAuthenticate = usbkeyAuthenticate;
	}

	public String getUsbkeyAffectMode() {
		return usbkeyAffectMode;
	}

	public void setUsbkeyAffectMode(String usbkeyAffectMode) {
		this.usbkeyAffectMode = usbkeyAffectMode;
	}

	public String getUsbkeyRangeIps() {
		return usbkeyRangeIps;
	}

	public void setUsbkeyRangeIps(String usbkeyRangeIps) {
		this.usbkeyRangeIps = usbkeyRangeIps;
	}
	...
	public boolean isLdaptLogin() {
		if (getLoginAuth("ldap").equals(this.getLoginAuth()))
			return true;
		return false;
	}
	...
	public String getAdadminloginno() {
		return adadminloginno;
	}

	public void setAdadminloginno(String adadminloginno) {
		this.adadminloginno = adadminloginno;
	}

	public String getAdadminloginnopw() {
		return adadminloginnopw;
	}

	public void setAdadminloginnopw(String adadminloginnopw) {
		this.adadminloginnopw = adadminloginnopw;
	}

	public String getAdlogindomain() {
		return adlogindomain;
	}

	public void setAdlogindomain(String adlogindomain) {
		this.adlogindomain = adlogindomain;
	}
