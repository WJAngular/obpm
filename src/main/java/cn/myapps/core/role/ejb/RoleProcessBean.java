...
public class RoleProcessBean extends AbstractDesignTimeProcessBean<RoleVO> implements RoleProcess {
	...
	public void doRemove(String pk) throws Exception {
		...
		if (role.getUsers() != null && !role.getUsers().isEmpty()) {
			throw new OBPMValidateException("(" + role.getName() + "){*[core.role.cannotremove]*}");
		}
	...
	public Collection<RoleVO> getRolesByDepartments(Collection<String> deptids) throws Exception {
		String[] dpetArray = (String[]) deptids.toArray(new String[deptids.size()]);
	...
	public Collection<RoleVO> getDefaultRolesByApplication(String applicationId)throws Exception {
		return ((RoleDAO) getDAO()).getDefaultRolesByApplication(applicationId);
	}
}
