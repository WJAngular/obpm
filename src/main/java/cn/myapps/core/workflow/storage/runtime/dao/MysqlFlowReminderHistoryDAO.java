 ...
 *
 */
public class MysqlFlowReminderHistoryDAO extends AbstractFlowReminderHistoryDAO implements FlowReminderHistoryDAO {

	public MysqlFlowReminderHistoryDAO(Connection conn) throws Exception {
		super(conn);
		dbTag = "MY SQL: ";
		if (conn != null) {
			try {
