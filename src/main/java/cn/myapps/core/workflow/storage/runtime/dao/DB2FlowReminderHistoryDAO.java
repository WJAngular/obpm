 ...
 *
 */
public class DB2FlowReminderHistoryDAO extends AbstractFlowReminderHistoryDAO implements FlowReminderHistoryDAO {

	public DB2FlowReminderHistoryDAO(Connection conn) throws Exception {
		super(conn);
		if (conn != null) {
			try {
