 ...
 * 
 */
public class HsqldbFlowReminderHistoryDAO extends AbstractFlowReminderHistoryDAO implements FlowReminderHistoryDAO {

	public HsqldbFlowReminderHistoryDAO(Connection conn) throws Exception {
		super(conn);
		dbTag = "HypersonicSQL: ";
		if (conn != null) {
