...
public abstract class Node extends PaintElement {
	...
	public static final int TXTH = 45;
	
	public static final int IMGX = 10;
	...
	protected void resize() {
		...
		this._imgrect.setBounds(x + IMGX, y, 45, 45);
		this._txtrect.setBounds(x, y + TXTH , width, fm.getHeight());
	...
	protected void resizeForMobile() {
		...
		_txtrect.setBounds(x, y + m_height - fm.getHeight(), m_width, fm.getHeight());
		_iconrect.setBounds(x + m_width, y, 25, 25);
	}
	...
	public void moveTo(int x, int y) {
		this.x = (int) (x - _handlePoint.x);
		this.y = (int) (y - _handlePoint.y);
