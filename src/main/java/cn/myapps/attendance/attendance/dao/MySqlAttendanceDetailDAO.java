...
public class MySqlAttendanceDetailDAO extends AbstractAttendanceDetailDAO implements AttendanceDetailDAO {

	public MySqlAttendanceDetailDAO(Connection conn) throws Exception {
		super(conn);
		dbTag = "MY SQL: ";
		if (conn != null) {
			try {
