...
public class MsSqlAttendanceDetailDAO extends AbstractAttendanceDetailDAO implements AttendanceDetailDAO {
	private static final Logger log = Logger.getLogger(MsSqlAttendanceDetailDAO.class);
	public MsSqlAttendanceDetailDAO(Connection conn) throws Exception {
		super(conn);
		dbTag = "MS SQL SERVER: ";
		try {
