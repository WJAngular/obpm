package cn.myapps.desktop.view;
...
//			}
	...
	public void setApplication(String application) {
		...
		String appId = (String) getContext().getSession().get(Web.SESSION_ATTRIBUTE_APPLICATION);
		if (StringUtil.isBlank(application)) {
			this.application = appId;
		} else {
			if (!application.equals(appId)) {
				getContext().getSession().put(Web.SESSION_ATTRIBUTE_APPLICATION, application);
			}
		}
	}
