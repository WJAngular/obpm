package cn.myapps.core.macro.editor.components.editor
{
	...
	private var _globalFormat:TextFormat = new TextFormat();//全局
	...
	function format(display_txt:TextField)
	{
		...
		display_txt.setTextFormat(globalFormat);
	...
	public function set globalFormat(value:TextFormat):void  {
		this._globalFormat = value;
	}
