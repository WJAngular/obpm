package main.flex.cn.myapps.core.printer.components
{
	 ...
	 * 
	 */
	public class HeaderCanvas extends MyCanvas
	{
		public function HeaderCanvas(startX:int=0, startY:int=0, endX:int=0, endY:int=0, lineColor:uint=0xFFFFFF, fillColor:uint=0xFFFFFF, thickness:Number=1)
		{
