package main.flex.cn.myapps.core.printer.components
{
	 ...
	 * 
	 */
	public class ItemTextBox extends ItemDraw
	{
		...
		public function ItemTextBox(startX:int=0, startY:int=0, endX:int=0, endY:int=0, lineColor:uint=0x000000, fillColor:uint=0xFFFFFF, thickness:Number=1)
		{
