function ubbEditor(_id)
{
  ...
  this.tToolbarSets['mini'] = ['Source','separator','Bold','Italic','Underline','separator','Smiley','separator','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','separator','OrderedList','UnorderedList','TextColor','BGColor','separator'];
