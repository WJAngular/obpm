...
<script src="<s:url value="/script/list.js"/>"></script>
	...
	var back = "<s:url value = '/portal/workflow/storage/runtime/more-circulatorlist-default.action'/>%3FsummaryCfgId=" + '<s:property value="summaryCfg.id"/>';
	...
	jQuery(document).ready(function init(){
		...
		var summaryCfgId = '<s:property value="summaryCfg.id"/>';
	   	...
	   	var td_head =document.getElementById("header");
			...
			jQuery("[moduleType='pending']").obpmPending(); 
	...
	<s:form name="formList" action="more-circulatorlist-default" theme="simple" method="post">
	...
	<div style="padding:5px;height: 100%\9;">
		<table width="100%">
			<tr>
				<td width="30%">
					<img src="<s:url value="/resource/image/email2.jpg"/>" /><span style="">{*[待阅]*}{*[List]*}</span>
				</td>
		...
		<table style="width: 100%;border: 1px solid #BFBFBF;">
			<tr>
				<td style="padding-left: 15px;">
					...
					<div class="context">
						<table cellspacing="2" cellpadding="0" style="width:97%; background-color: #FFFFFF;">
