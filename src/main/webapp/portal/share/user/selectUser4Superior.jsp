...
<script type="text/javascript">
	...
	function getOnLineUserList(){
		...
		jQuery.ajax({
					url:contextPath+"/portal/user/getOnLineUser4ProxyOrSuperior.action",
					type:"post",
					datatype:"jason",
	...
	function getAllUser(param){
		...
		if(domainid!=""){
			jQuery.ajax({
					url:contextPath+"/portal/user/getAllUser4ProxyOrSuperior.action",
					type:"post",
					datatype:"jason",
	...
	function getUserListByDept(domainid,deptid,deptname){
		if(domainid!="" && deptid!=""){
			...
			jQuery.ajax({
					url:contextPath+"/portal/user/treelist4ProxyOrSuperior.action",
					type:"post",
					datatype:"jason",
