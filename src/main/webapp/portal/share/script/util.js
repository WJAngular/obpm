...
function showWordDialog(title, url, str, docid, formName, value, fieldname, versions, opentype, displayType, isEdit, saveable, isOnlyRead,signature,isSignature) {
	wx = '900px';
	wy = '600px';
	var field = document.getElementById(fieldname);
...
/**
 * 浏览器判断
 * return brow:ie6/ie7/ie8/ie9/ie10/ie11/firefox/chrome/safari
 */
function getBrowser(){
	var ua = navigator.userAgent.toLowerCase();
	var rMsie = /(msie\s|trident.*rv:)(\d+)\.0/, rFirefox = /(firefox)\/([\w.]+)/, rChrome = /(chrome)\/([\w.]+)/, rSafari = /version\/([\w.]+).*(safari)/;
