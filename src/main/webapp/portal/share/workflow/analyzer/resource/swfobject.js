...
var swfobject = function() {
	...
	function u(ai, ag, Y) {
		...
		if (aa.InnerHTML == null || aa.InnerHTML=='') {
			if (typeof ai.id == D) {
				ai.id = Y
			}
			if (M.win) {
				...
				var quality = "high";
				var bgcolor = "";
				var allowScriptAccess = "allowScriptAccess";
				for ( var ad in ag) {
					if (ag[ad] != Object.prototype[ad]) {
						...
						if(ad =='movie'){
							...
							bgcolor = ag[ad];
						}else if(ad =='allowScriptAccess'){
							allowScriptAccess = ag[ad];
						}
					}
				}
				
				var embed = '<embed src="'+movie+'" quality="'+quality+'" bgcolor="'+bgcolor+'" width="100%" height="100%"';
