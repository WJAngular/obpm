...
<body style="margin:0px;width: 100%;height: 100%;">
	...
	<div id="map" style="position: absolute; left: 0px; z-index: 1; overflow: hidden; -webkit-user-select: none;font-family:arial, sans-serif;font-size:12px;font-variant:normal;overflow: hidden;width: 100%;"></div>
	...
	<div id="networktip" align="center" style="visibility:hidden;visitilyposition: absolute; left: 1px; z-index: 1; overflow: hidden; -webkit-user-select: none;font-family:arial, sans-serif;font-size:12px;font-variant:normal;overflow: hidden;width: 99%;height:100%;">
		<table style="background-color: white; position: absolute;z-index: 2;border-collapse: collapse;width: 100%;height: 90%;text-align: center;vertical-align: middle;">
			<tr>
