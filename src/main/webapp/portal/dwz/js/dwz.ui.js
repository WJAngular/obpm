...
//		ajaxbg.show();  //调用ajax，不需要展开遮罩  --jarod
	}).ajaxStop(function(){
//		ajaxbg.hide();
	});
...
function initLayout(){
	...
	var iContentW = winWidth - (DWZ.ui.sbar ? $("#sidebar").width() + 10 : 34) - 5;
	var iContentH = winHeight - $("#header").height() - 34;

	$("#container").width(iContentW);
	$("#container .tabsPageContent").height(iContentH - 34).find("[layoutH]").layoutH();
	$("#container .tabsPageContent iframe").height(iContentH - 34).find("[layoutH]").layoutH();
