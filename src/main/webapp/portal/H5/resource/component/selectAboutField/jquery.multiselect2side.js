...
(function($)
{
	jQuery.fn.multiselect2side = function (o) {
		...
		return this.each(function () {
			...
			if(o.readOnly){
				htmlToAdd += "<select title='" + o.labelsx + "' name='" + nameSx + "' id='" + nameSx + "' size='" + size + "' multiple='multiple' disabled='disabled'></select>";
			}else{
				htmlToAdd += "<select title='" + o.labelsx + "' name='" + nameSx + "' id='" + nameSx + "' size='" + size + "' multiple='multiple'></select>";
			}
			htmlToAdd += "</td>" +
			...
			if(o.readOnly){
				htmlToAdd += "<select title='" + o.labeldx + "' name='" + nameDx + "' id='" + nameDx + "' size='" + size + "' multiple='multiple' disabled='disabled'></select>";
			}else{
				htmlToAdd += "<select title='" + o.labeldx + "' name='" + nameDx + "' id='" + nameDx + "' size='" + size + "' multiple='multiple'></select>";
			}
			...
			//jquery1.11及之后版本不支持低版本浏览器，也不提供这个方法
