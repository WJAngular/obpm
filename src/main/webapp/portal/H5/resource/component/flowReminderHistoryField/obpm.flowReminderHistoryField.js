		...
		$field.find("table tr").each(function(i){//行<tr>
			...
			if(i==0){//列头
				...
				$trField.children().each(function(){
					...
					html.push("<th style='text-align:center;font-family: Arial;border:solid #cccccc;border-width:0px 1px 1px 0px;padding:10px;background-color:#EFF0F1;width="+$tdField.attr("width")+"' >");
				...
				$trField.children().each(function(){
					var $tdField = jQuery(this);
					html.push("<td style='font-family: Arial;border:solid #cccccc;border-width:0px 1px 1px 0px;text-align:center;'>");
