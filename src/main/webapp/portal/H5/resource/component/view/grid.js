...
function getGridParams() {
	// 获取act table 下的输入值
	var params = jQuery.par2Json(decodeURIComponent(jQuery('#acttable input,#acttable select,#acttable textarea').not(".dataTable input, .dataTable select, .dataTable textarea").serialize()),true);
	return params;
}
