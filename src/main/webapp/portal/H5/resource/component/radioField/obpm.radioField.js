...
//						name += name + "$forshow" ;
//					}
					html+="<label class='radio-inline'><input type='radio' id='" + id + "' isCommonFilter='"+isCommonFilter+"' value=\"" + value + "\" name='" + name + "' class='" + cssClass + "' " + otherAttrsHtml+" style='width:14px;height:14px; ";
					if(displayType == PermissionType_HIDDEN){
						html += "display:none;";
					}
					html += " '";
