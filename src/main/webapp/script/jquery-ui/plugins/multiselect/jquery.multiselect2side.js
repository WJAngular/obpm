		...
		return this.each(function () {
			...
			var htmlToAdd = 
				"<span class='ms2side__div'>" +
					...
					"</span>" +
					"<span class='ms2side__options'>" +
						((o.selectedPosition == 'right')
						?
						("<table style='display: inline;vertical-align:bottom;bottom;border-collapse:collapse;'><tr><td><p class='AddOne' title='Add Selected'>&rsaquo;</p></td></tr>" +
						...
						:
						("<table style='display: inline;vertical-align:bottom;bottom;border-collapse:collapse;'><tr><td><p class='AddOne' title='Add Selected'>&lsaquo;</p></td></tr>" +
					...
					"</span>" +
					"<span class='ms2side__select'>" +
						(o.labeldx ? ("<div class='ms2side__header'>" + o.labeldx + "</span>") : "") +
						"<select title='" + o.labeldx + "' name='" + nameDx + "' id='" + nameDx + "' size='" + size + "' multiple='multiple' ></select>" +
					"<span style='border:0;margin-left:10px;'>"+ o.discript +"</span></span>" +
					((o.selectedPosition == 'right' && o.moveOptions) ? divUpDown : "") +
				"</span>";
