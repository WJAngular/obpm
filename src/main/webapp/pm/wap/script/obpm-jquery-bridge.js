...
(function($) {
	...
	OBPM.dialog = OBPM.dialog ? OBPM.dialog : {
		...
		show : function(options) {
			...
			$body.find("#dlg_"+_index).append("<div class='content'><iframe src='"+url+"' frameborder='0' allowtransparency='true' style='width: 100%; height: 100%; border: 0px none;'></iframe></div>");

			$body.find("#dlg_"+_index).find(">div>iframe").load(function(){
				options._pageYOffset = window.pageYOffset;
