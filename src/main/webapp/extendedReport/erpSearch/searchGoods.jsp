...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav in" id="side-menu">
	                    ...
	                    <li>
	                        <a href="./searchGoods.jsp" class="active"><i class="fa fa-table fa-fw"></i>货品查询</a>
	                    </li>
	                    <li>
        ...
        <div id="page-wrapper" style="min-height: 560px;">
            ...
            <div class="row" id="huopin_Search">
               <div class="col-lg-12">
                	<article class="obpmSearch"  _val="huopin"  title="货品查询" _name="">
                		<h1 class="page-header">货品查询
                		...
                		<div class="dataSearch" style="display:none;">
                			<form class="dataSearch-from">
								<div class="column">
									...
									<div class="col-sm-2"><input type="text" class="form-control" name="_jname"/></div>
									<div class="col-sm-1 textAlign">全称:&nbsp;</div>
									<div class="col-sm-2"><input type="text" class="form-control" name="_fullname"/></div>
									<div class="col-sm-1 textAlign">规格:&nbsp;</div>
									<div class="col-sm-2">
										<input type="text" class="form-control" name="_gdspec"/>
									</div>
								...
								<div class="column">
									...
									<div class="col-sm-2"><input type="text" class="form-control" name="_code" id="code"/></div>
									
								</div>
								<div class="col-sm-12 text-center">
									<button type="button" class="btn btn-primary submit" _val="hpsearch"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> 查询</button>
