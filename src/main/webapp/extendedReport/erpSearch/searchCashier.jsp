...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav in" id="side-menu">
	                    ...
	                    <li>
	                        <a href="./searchCashier.jsp" class="active"><i class="fa fa-table fa-fw"></i>出纳账查询</a>
	                    </li>
	                    <li>
        ...
        <div id="page-wrapper" style="min-height: 560px;">
            ...
            <div class="row" id="cnz_Search">
               <div class="col-lg-12">
                	<article class="obpmSearch"  _val="cnz"  title="出纳账查询" _name="">
                		<h1 class="page-header">出纳账查询
								...
								<div class="column chuna">
							        ...
							        <div class="form-group col-sm-4">
							            ...
							            <div class="input-group date form_datetime col-sm-8">
					                		<input class="form-control start-time" size="16" type="text" value="" name="startTime">
							        ...
							        <div class="form-group col-sm-4">
							            ...
							            <div class="input-group date form_datetime col-sm-8">
							                <input class="form-control end-time" size="16" type="text" value="" name="endTime">
							                <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
							            </div>
							        </div>
							        <div class="form-group col-sm-4">
							            <label class="control-label col-sm-4">出纳账户</label>
										<div class="control-select col-sm-8">
											<select class="form-control accoutname_select" name="accoutname" _val="accoutname" stype="_default">
												<option >&nbsp;</option>
											</select>
										</div>	
							        </div>
