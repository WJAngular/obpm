...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav in" id="side-menu">
	                    ...
	                    <li>
	                        <a href="./searchWarehouse.jsp" class="active"><i class="fa fa-table fa-fw"></i>分仓库库存查询</a>
	                    </li>
	                    <li>
        ...
        <div id="page-wrapper" style="min-height: 560px;">
            ...
            <div class="row" id="fck_Search">
               <div class="col-lg-12">
                	<article class="obpmSearch"  _val="fckkc"  title="分仓库库存查询" _name="">
                		<h1 class="page-header">分仓库库存查询
                		...
                		<div class="dataSearch" style="display:none;">
                			<form class="dataSearch-from">
								<div class="column">
									<div class="col-sm-2 textAlign">产品编号:&nbsp;</div>
									<div class="col-sm-2"><input type="text" class="form-control" name="_gdcood" id="gdcood"/></div>
									<div class="col-sm-2 textAlign">类别:&nbsp;</div>
									<div class="col-sm-2">
										<select class="form-control tradertype_select" name="tradertype"  _val="tradertype" stype="_default">
											<option>&nbsp;</option>
										</select>
									</div>
									<div class="col-sm-2 textAlign">隶属部门:&nbsp;</div>
									<div class="col-sm-2">
								...
								<div class="column">
									<div class="col-sm-2 textAlign">名称:&nbsp;</div>
									<div class="col-sm-6"><input type="text" class="form-control" name="_gdname" id="gdname"/></div>
									<div class="col-sm-2 textAlign">规格:&nbsp;</div>
									<div class="col-sm-2"><input type="text" class="form-control" name="_gdspec" id="gdspec"/></div>
								</div>
								<div class="column">
									<div class="col-sm-2 textAlign">仓库:&nbsp;</div>
									<div class="col-sm-2"><input type="text" class="form-control" name="_stname" id="stname"/></div>
									<div class="col-sm-2 textAlign">单位:&nbsp;</div>
									<div class="col-sm-2"><input type="text" class="form-control" name="_unitname" id="unitname"/></div>
								...
								<div class="col-sm-12 text-center">
									<button type="button" class="btn btn-primary submit" _val="cksearch"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> 查询</button>
