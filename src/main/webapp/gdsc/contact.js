$(function(){
	...
	$("a[title='打印']").unbind('click').bind('click',function(){
		...
		if(docNo == ""){
			...
			window.open("http://192.168.1.30:8080/obpm/ReportServer?reportlet=wlPrint.cpt&number="+docNo);
		}
	});
});
...
var $this = {
	'defaultHideValue':function(){
			attrItem("费用类型","value","往来费");
			attrItem("往来款申请","value","往来款申请");
		},	
