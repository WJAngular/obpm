$(function(){
	...
	$("a[title='打印']").unbind('click').bind('click',function(){
		...
		if(docNo == ""){
			...
			window.open("http://192.168.1.30:8080/obpm/ReportServer?reportlet=xlPrint.cpt&number="+docNo);
		}
	});
});
...
var $this = {
	'defaultHideValue':function(){
			attrItem("费用类型","value","零星费");
			attrItem("零星费申请","value","零星费申请");
		},
