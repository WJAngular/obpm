...
<title>{*[cn.myapps.km.report.department_list]*}</title>
</head>
<style>
...
function init(){
	...
	function query(){
		...
		url ='departmentuploadreport.jsp?startDate='+startDate + '&endDate='+endDate+'&columns='+columnValue;
	    window.location = url;
	}
</script>
<body onload= "init()">
...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="100%" height="100%" codebase="HTTP/1.1://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" id="ie_chart" align="middle">
	...
	<param name="movie" value="open-flash-chart.swf?data-file=sumDepartmentupload.action?startDate=<%=startDate%>%26endDate=<%=endDate%>%26columns=<%=columns%>">
	<param name="quality" value="high">
	<param name="bgcolor" value="#eeeeee">
	<param name="wmode" value="window">
	<embed src="open-flash-chart.swf?data-file=sumDepartmentupload.action?startDate=<%=startDate%>%26endDate=<%=endDate%>%26columns=<%=columns%>" quality="high" width="100%" height="100%" bgcolor="#eeeeee" style="width:100%;height:100%;" name="chart" align="middle" allowscriptaccess="sameDomain" type="application/x-shockwave-flash" pluginspage="HTTP/1.1://www.macromedia.com/go/getflashplayer" id="chart3" wmode="window">
</object>
</div>
</div>
</body>
