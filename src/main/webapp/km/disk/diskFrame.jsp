...
<script type="text/javascript">
	...
	function openHomePage(){
		jQuery("#diskFrame").attr("src","<s:url value='/km/disk/view.action'><s:param name='_type' value='%{#parameters._type}'/></s:url>"); 
	}
	function getDimensions(){
		var bodyH = jQuery(document).height() - 10;
...
<div id="container" class="container" >
		...
		<div id="act" class="act" >
			...
			<div class="act_center">
				<div id="action" class="action">
					<a target="main" href="<s:url value='/km/index.jsp'/>" class="dbank">{*[cn.myapps.km.disk.homepage]*}</a>
					...
					<a target="main" href="<s:url value='/km/disk/diskHelp.jsp'/>" target="about" class="help">{*[cn.myapps.km.disk.help]*}</a>
				</div>
			</div>
	...
	<div class="diskFrame_box">
		<iframe name="main" id="diskFrame" src="<s:url value='/km/disk/view.action'><s:param name='_type' value='%{#parameters._type}'/></s:url>" width="100%" height="100%" frameborder="0" scrolling="no" ></iframe>
	</div>
</div>
</body>
