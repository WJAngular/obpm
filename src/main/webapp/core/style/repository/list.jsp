...
jQuery(document).ready(function(){
	inittab();
	cssListTable();
	window.top.toThisHelpPage("application_info_libraries_styleLibs_list");
});

</script>
<link rel="stylesheet" href="<s:url value='/resource/css/main.css' />"	type="text/css">
</head>
<body id="application_info_libraries_styleLibs_list" class="body-back">
	...
	<table class="table_noborder">
		...
		<s:iterator value="datas.datas" status="index">
			...
			<td ><a
				...
				<s:param name="selected" value="%{'btnStyleLibs'}" />
			...
			<td><s:property value="content.length()>60?content.substring(0,60):content" /></td>
			</tr>
		</s:iterator>
	</table>
