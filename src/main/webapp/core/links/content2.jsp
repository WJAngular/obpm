...
<%@page import="cn.myapps.core.email.util.Constants"%><html><o:MultiLanguage>
	<head>
...
function doSave(type){
	...
	var url ='';
	var url = contextPath+"/core/links/save2.action?sm_name=" + "<s:property value='#parameters.sm_name' />" + "&s_type=" + "<s:property value='#parameters.s_type' />";
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr >
					...
					<button type="button" class="button-image"
						onClick="forms[0].action='<s:url action="selectlink"><s:param name="sm_name" value="#parameters.sm_name"/><s:param name="s_type" value="#parameters.s_type"/></s:url>';forms[0].submit();"><img
	...
	<s:form action="save" method="post"
		...
		<tr>
			...
			<s:select cssStyle="width:350px;" cssClass="input-cmd"
					...
					list="#{'':'{*[Select]*}','00':'{*[Form]*}','01':'{*[View]*}','02':'{*[cn.myapps.core.dynaform.links.report]*}','09':'{*[cn.myapps.core.dynaform.links.customize_report]*}','03':'{*[cn.myapps.core.dynaform.links.excel_import]*}','05':'{*[cn.myapps.core.dynaform.links.customize_links_internal]*}','06':'{*[cn.myapps.core.dynaform.links.customize_links_External]*}','07':'{*[cn.myapps.core.dynaform.links.script_links]*}','08':'{*[cn.myapps.core.dynaform.links.email_links]*}'}"
		...
		<tr id="oexternal_tr" style="display:none;">
			<td align="left">
				...
				<s:textfield id="externalLinks" cssClass="input-cmd"  cssStyle="width:73%;" theme="simple" name="externalLinks" /></div></td>
		</tr>
