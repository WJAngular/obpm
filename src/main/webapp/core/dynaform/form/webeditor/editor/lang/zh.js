...
ComponentField: '插入/編輯組件',
ComponentFieldDlgTitle: '組件屬性',
ComponentFieldDlgName: '組件名稱',
ComponentFieldErrNoName: '請輸入占位符名稱',
ComponentFieldErrNameInUse: '指定名稱已被使用',

ImageUploadField: '圖片上傳',
ImageUploadFieldDlgTitle: '圖片上傳',
ImageUploadFieldDlgName: '圖片上傳',
ImageUploadFieldErrNoName: '圖片上傳',
ImageUploadFieldErrNameInUse: '圖片上傳',
ImageUploadFieldProp: '圖片上傳屬性',

ImageUploadToDataBaseField: '圖片上傳到數據庫',
ImageUploadToDataBaseFieldDlgTitle: '圖片上傳到數據庫',
ImageUploadToDataBaseFieldDlgName: '圖片上傳到數據庫',
ImageUploadToDataBaseFieldErrNoName: '圖片上傳到數據庫',
ImageUploadToDataBaseFieldErrNameInUse: '圖片上傳到數據庫',
ImageUploadToDataBaseFieldProp: '圖片上傳到數據庫屬性',

FileManagerField: '文件管理',
FileManagerFieldDlgTitle: '文件管理',
FileManagerFieldDlgName: '文件管理',
FileManagerFieldErrNoName: '文件管理',
FileManagerFieldErrNameInUse: '文件管理',
FileManagerFieldProp: '文件管理屬性',


onlinetakephotoField: '在線拍照',
onlinetakephotoFieldDlgTitle: '在線拍照',
onlinetakephotoFieldDlgName: '在線拍照',
onlinetakephotoFieldErrNoName: '在線拍照',
onlinetakephotoFieldErrNameInUse: '在線拍照',
onlinetakephotoFieldProp: '在線拍照屬性',


reminderField: '待辦',
reminderFieldDlgTitle: '待辦',
reminderFieldDlgName: '待辦',
reminderFieldErrNoName: '待辦',
reminderFieldErrNameInUse: '待辦',
reminderFieldProp: '待辦屬性',

mapField: '地圖',
mapFieldDlgTitle: '地圖',
mapFieldDlgName: '地圖',
mapFieldErrNoName: '地圖',
mapFieldErrNameInUse: '地圖',
mapFieldProp: '地圖屬性',


AttachmentUploadField				: '文件上傳',
AttachmentUploadFieldDlgTitle		: '文件上傳',
AttachmentUploadFieldDlgName		: '文件上傳',
AttachmentUploadFieldErrNoName		: '文件上傳',
AttachmentUploadFieldErrNameInUse	: '文件上傳',
AttachmentUploadFieldProp			: '文件上傳屬性',


//AttachmentUploadField
AttachmentUploadToDataBaseField            : '文件上傳到數據庫',
AttachmentUploadToDataBaseFieldDlgTitle    : '文件上傳到數據庫',
AttachmentUploadToDataBaseFieldDlgName     : '文件上傳到數據庫',
AttachmentUploadToDataBaseFieldErrNoName   : '文件上傳到數據庫',
AttachmentUploadToDataBaseFieldErrNameInUse: '文件上傳到數據庫',
AttachmentUploadToDataBaseFieldProp        : '文件上傳到數據庫屬性',

ViewDialogField				:"視圖選擇框",
ViewDialogFieldDlgTitle		:"視圖選擇框",
ViewDialogFieldDlgName		:"視圖選擇框",
ViewDialogFieldProp     	:"視圖選擇框屬性",
ViewDialogFieldErrNameInUse	:"指定名稱已被使用",

CalcTextField				:"計算腳本",
CalcTextFieldDlgTitle		:"計算腳本",
CalcTextFieldProp   		:"計算腳本屬性",
CalcTextFieldErrNoName   	:"計算腳本",
CalcTextFieldErrNameInUse	:"計算腳本",

suggestfield				:"智能提示搜索框",
suggestfieldtitle			:"智能提示搜索框",
suggestfieldprop       		:"智能提示搜索框属性",

includefield				:"包含元素",
includefieldtitle			:"包含元素",
includefieldprop			:"包含元素屬性",
...
datefield					:"日期選擇框",
datefieldtitle				:"日期選擇框",
datefieldtitleprop			:"日期選擇框屬性",

departmentfield				:"部門選擇框",
departmentfieldtitle		:"部門選擇框",
departmentfieldprop      	:"部門選擇框屬性",

wordfield					:"WORD編輯器",
wordfieldtitle				:"WORD編輯器",
wordfieldprop				:"WORD編輯器屬性",

htmleditorfield				:"HTML編輯器",
htmleditorfieldtitle		:"HTML編輯器",
htmleditorfieldprop			:"HTML編輯器屬性",

userfield       			:"用戶選擇框",
userfieldtitle 				:"用戶選擇框",
userfieldfieldprop 			:"用戶選擇框屬性",

treedepartmentfield      				:"樹形部門選擇框",
treedepartmentfieldtitle  			:"樹形部門選擇框",
treedepartmentfieldfieldprop 			:"樹形部門選擇框屬性",

selectaboutfield            :"左右選擇框",
selectaboutfieldtitle       :"左右選擇框",
selectaboutfieldprop 		:"左右選擇框屬性",

flowhistoryfield				:"流程歷史",
flowhistoryfieldtitle		:"流程歷史",
flowhistoryfieldprop			:"流程歷史屬性",

flowreminderhistoryfield				:"流程催辦歷史",
flowreminderhistoryfieldtitle		:"流程催辦歷史",
flowreminderhistoryfieldprop			:"流程催辦歷史屬性",

weixingpsfield				:"微信GSP定位",
weixingpsfieldtitle		:"微信GSP定位",
weixingpsfieldprop			:"微信GSP定位屬性",

surveyfield				:"调查控件",
surveyfieldtitle		:"调查控件",
surveyfieldprop			:"调查控件属性",

weixinrecordfield				:"微信录音控件",
weixinrecordfieldtitle		:"微信录音控件",
weixinrecordfieldprop			:"微信录音控件属性",

qrcodefield				:"二维码控件",
qrcodefieldtitle		:"二维码控件",
qrcodefieldprop			:"二维码控件属性",

informationfeedbackfield			:"信息反饋",
informationfeedbackfieldtitle		:"信息反饋",
informationfeedbackfieldprop		:"信息反饋屬性",
