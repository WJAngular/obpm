...
ComponentField: '插入/编辑 组件',
ComponentFieldDlgTitle: '组件属性',
ComponentFieldDlgName: '组件名称',
ComponentFieldErrNoName: '请输入占位符名称',
ComponentFieldErrNameInUse: '指定名称已被使用',

ImageUploadField: '图片上传',
ImageUploadFieldDlgTitle: '图片上传',
ImageUploadFieldDlgName: '图片上传',
ImageUploadFieldErrNoName: '图片上传',
ImageUploadFieldErrNameInUse: '图片上传',
ImageUploadFieldProp: '图片上传属性',

ImageUploadToDataBaseField: '图片上传到数据库',
ImageUploadToDataBaseFieldDlgTitle: '图片上传到数据库',
ImageUploadToDataBaseFieldDlgName: '图片上传到数据库',
ImageUploadToDataBaseFieldErrNoName: '图片上传到数据库',
ImageUploadToDataBaseFieldErrNameInUse: '图片上传到数据库',
ImageUploadToDataBaseFieldProp: '图片上传到数据库属性',
...
FileManagerFieldProp: '文件管理属性',


onlinetakephotoField: '在线拍照',
onlinetakephotoFieldDlgTitle: '在线拍照',
onlinetakephotoFieldDlgName: '在线拍照',
onlinetakephotoFieldErrNoName: '在线拍照',
onlinetakephotoFieldErrNameInUse: '在线拍照',
onlinetakephotoFieldProp: '在线拍照属性',


reminderField: '待办',
reminderFieldDlgTitle: '待办',
reminderFieldDlgName: '待办',
reminderFieldErrNoName: '待办',
reminderFieldErrNameInUse: '待办',
reminderFieldProp: '待办属性',

mapField: '地图',
mapFieldDlgTitle: '地图',
mapFieldDlgName: '地图',
mapFieldErrNoName: '地图',
mapFieldErrNameInUse: '地图',
mapFieldProp: '地图属性',


AttachmentUploadField				: '文件上传',
AttachmentUploadFieldDlgTitle		: '文件上传',
AttachmentUploadFieldDlgName		: '文件上传',
AttachmentUploadFieldErrNoName		: '文件上传',
AttachmentUploadFieldErrNameInUse	: '文件上传',
AttachmentUploadFieldProp			: '文件上传属性',


//AttachmentUploadField
AttachmentUploadToDataBaseField            : '文件上传到数据库',
AttachmentUploadToDataBaseFieldDlgTitle    : '文件上传到数据库',
AttachmentUploadToDataBaseFieldDlgName     : '文件上传到数据库',
AttachmentUploadToDataBaseFieldErrNoName   : '文件上传到数据库',
AttachmentUploadToDataBaseFieldErrNameInUse: '文件上传到数据库',
AttachmentUploadToDataBaseFieldProp        : '文件上传到数据库属性',

ViewDialogField				:"视图选择框",
ViewDialogFieldDlgTitle		:"视图选择框",
ViewDialogFieldDlgName		:"视图选择框",
ViewDialogFieldProp     	:"视图选择框属性",
ViewDialogFieldErrNameInUse	:"指定名称已被使用",

CalcTextField				:"计算脚本",
CalcTextFieldDlgTitle		:"计算脚本",
CalcTextFieldProp   		:"计算脚本属性",
CalcTextFieldErrNoName   	:"计算脚本",
CalcTextFieldErrNameInUse	:"计算脚本",
...
datefield					:"日期选择框",
datefieldtitle				:"日期选择框",
datefieldtitleprop			:"日期选择框属性",

departmentfield				:"部门选择框",
departmentfieldtitle		:"部门选择框",
departmentfieldprop      	:"部门选择框属性",

wordfield					:"WORD编辑器",
wordfieldtitle				:"WORD编辑器",
wordfieldprop				:"WORD编辑器属性",

htmleditorfield				:"HTML编辑器",
htmleditorfieldtitle		:"HTML编辑器",
htmleditorfieldprop			:"HTML编辑器属性",

userfield       			:"用户选择框",
userfieldtitle 				:"用户选择框",
userfieldfieldprop 			:"用户选择框属性",

treedepartmentfield      				:"树形部门选择框",
treedepartmentfieldtitle  			:"树形部门选择框",
treedepartmentfieldfieldprop 			:"树形部门选择框属性",

selectaboutfield            :"左右选择框",
selectaboutfieldtitle       :"左右选择框",
selectaboutfieldprop 		:"左右选择框属性",

flowhistoryfield				:"流程历史",
flowhistoryfieldtitle		:"流程历史",
flowhistoryfieldprop			:"流程历史属性",

flowreminderhistoryfield				:"流程催办历史",
flowreminderhistoryfieldtitle		:"流程催办历史",
flowreminderhistoryfieldprop			:"流程催办历史属性",

weixingpsfield				:"微信GPS定位",
weixingpsfieldtitle		:"微信GPS定位",
weixingpsfieldprop			:"微信GPS定位屬性",
...
informationfeedbackfield			:"信息反馈",
informationfeedbackfieldtitle		:"信息反馈",
informationfeedbackfieldprop		:"信息反馈属性",
...
RadioButtonProp		: "单选框属性",
ImageButtonProp		: "图像域属性",
TextFieldProp		: "单行文本属性",
SelectionFieldProp	: "下拉框属性",
TextareaProp		: "多行文本属性",
FormProp			: "表单属性",
