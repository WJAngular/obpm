...
var FCKDialog = ( function()
{
	...
	/*
	 * dolly 2010-12-20 modify:不取顶层，取顶层的下一层
	 * */
	var topWindow=window;//XXXXX

	while ( topWindow.parent && topWindow.parent != top )//topXXXXX
	{
		try
		{
	...
	return {
		...
		OnDialogClose : function( dialogWindow )
		{
			...
			if(moduleid!="" && moduleid!="null"){
				//模块--表单
				window.top.toThisHelpPage("application_module_form_info_advance");
			}else{
				//常用工具--首页
		...
		DisplayMainCover : function()//llllllllllllllllllllllllllllllllllllllllllllllllllllllllllll
		{
