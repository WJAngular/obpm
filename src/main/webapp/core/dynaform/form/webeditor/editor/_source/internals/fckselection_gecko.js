...
FCKSelection.GetSelectedElement = function()
{
	...
	if (( range.startContainer != range.endContainer || range.startContainer.nodeType != 1 || range.startOffset != range.endOffset - 1) && document.documentMode != 10)
		return null ;

	var node = range.startContainer.childNodes[ range.startOffset ] ;
	
	if(!node && document.documentMode == 10 && range.startOffset == 1){
