...
function InitDocument(){
	...
	resize();
	window.top.toThisHelpPage("application_module_form_info_advance_radio");
...
function Ok()
{
	...
	var className="cn.myapps.core.dynaform.form.ejb.RadioField";
	var id=getFieldId();	
...
<s:hidden name="formid" id="formid" value="%{#parameters.formid}" ></s:hidden>
		<table border=0 cellpadding=3 cellspacing=0 width="520px">
			...
			<tr>
				<td align=center valign=middle colspan=14 bgcolor=#ffffff>
				<table border=1 cellpadding=3 cellspacing=1 class="content"
					id="content1">
					<tr>
						<td class="commFont commLabel">{*[Name]*}:</td>
						<td colspan="3"><input type=text id="name" name="name" onchange="checkStartChar(this.value);"></td>
					</tr>
