 ...
 * fck编辑器多语言处理
 */
var language = '<%=(String) session.getAttribute(Web.SESSION_ATTRIBUTE_USERLANGUAGE)%>';
if(language == "CN"){
	language = "zh-cn";
}else if(language == "TW"){
	language = "zh";
...
if(document.documentMode != 10){
	...
	LoadScript( '_source/classes/fckdomrange_ie10.js' ) ;
}
...
if(document.documentMode != 10){
	...
	LoadScript( '_source/internals/fckselection_ie10.js' ) ;	
}	
...
window.onload = function()
{
	...
	if ( FCKBrowserInfo.IsIE && document.documentMode != 10)
		FCK_PreloadImages() ;
	else
		LoadToolbarSetup() ;
}
...
function init(){
	...
	//alert("document.getElementById().value----->"+document.getElementById('applicationid').value);
}
	</script>
</head>
<body>
