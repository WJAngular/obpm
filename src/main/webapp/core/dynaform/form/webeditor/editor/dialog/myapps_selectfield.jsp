...
<%
 ...
 %>
	...
	function InitDocument() {
		...
		resize();
		window.top.toThisHelpPage("application_module_form_info_advance_select");
	...
	function Ok() {
		...
		var className = "cn.myapps.core.dynaform.form.ejb.SelectField";
		var id = getFieldId();
	...
	<table border=0 cellpadding=3 cellspacing=0  width="540px">
		<tr>
