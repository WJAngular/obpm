...
.fontawesome-icon-list .fa-hover a.fa-select .fa,
...
<div class="container">
	<div id="icons">
		<section id="new">
			<h2 class="page-header">New Icons</h2>
  ...
  <div class="alert alert-success">
    <ul class="fa-ul">
      <li>
        ...
        <a  class="alert-link">spinning icons example</a>.
      </li>
    </ul>
  </div>
...
<a  class="alert-link">report an issue with Adblock Plus</a> if you believe this to be
