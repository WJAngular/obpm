...
/////////////
var currLine = document.getElementById('currLine').value;

if (currLine && i == currLine-1){
	li.style.color='red';
...
_76.source=_7d;
//////
if (_7d.previousSibling){
	_7d.parentNode.removeChild(_7d.previousSibling);
}
/////
