...
<s:form name="formList" action="selectflow" method="post" theme="simple">
...
<table border="0" width="100%" align="center" cellpadding="2" cellspacing="2"
		width="100%">
		<tr >
			<th class="column-head" ><o:OrderTag field="subject" css="ordertag">{*[Name]*}</o:OrderTag></th>
		...
		<s:iterator value="datas.datas" status="index">
			...
			<s:else>
				...
				<td>
					<a href="javascript:doSelect('<s:property value="id" />;<s:property value="subject" />')">
