...
Calendar.prototype.getHeader = function()
{
	...
	str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="previousYear" title="Last Year" style="cursor:pointer;width:10px;" onclick="'+this.Obj+'.onChangeYear(false);"><<</td>\n';
	str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="previousMonth" title="Last Month" style="cursor:pointer;width:10px;" onclick="'+this.Obj+'.onChangeMonth(false);"><</td>\n';
	...
	str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="nextMonth" title="Next Month" style="cursor:pointer;width:10px;" onclick="'+this.Obj+'.onChangeMonth(true);">></td>\n';
	str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="nextYear" title="Next Year" style="cursor:pointer;width:10px;" onclick="'+this.Obj+'.onChangeYear(true);">>></td></tr>\n';
	str += '</table>\n';
	return str;
};
...
Calendar.prototype.getBody = function()
{
   ...
   str += '</table>\n';
   str += '<table Author="alin" class="cdrBodyBar" cellSpacing="2" cellPadding="0"><tr align="center" Author="alin"><td Author="alin" style="cursor:pointer;" onclick="'+this.Obj+'.getToday();">Today：'+new Date().toFormatString("yyyy-mm-dd")+'</td></tr></table>\n';
   return str;
};
...
Calendar.prototype.show = function()
{
   ...
   {
      alert("Sorry！The arguments was wrong！" );
	  return;
	}   
   ...
   for(i = 0; i < arguments.length; i++)
   {
	...
	if(!_date){alert("The arguments was wrong!"); return;}
...
Calendar.prototype.bindHeader = function()
{
   ...
   _curMonth.innerHTML =  this.date.toFormatString("MMM");
...
Calendar.prototype.onChangeYear = function(isnext)
{
   ...
   {
     alert("Year value overflow（1000-9999）!");
   }
...
Date.prototype.toFormatString = function(fs)
{
   ...
   if(fs.length == 1)
   { 
     return this.getFullYear() + fs + (months >= 10 ? months : '0' + months) + fs + (days >= 10 ? days: '0' + days); 
   }
   
   fs = fs.replace("yyyy", this.getFullYear());
   fs = fs.replace("mm",(months >= 10 ? months : '0' + months));
   fs = fs.replace("MMM", monthStr[this.getMonth()]);
   fs = fs.replace("dd",(days >= 10 ? days: '0' + days));
   return fs;
}
